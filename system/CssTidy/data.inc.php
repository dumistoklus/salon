 ...
 */
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //string before @rule
$GLOBALS['csstidy']['predefined_templates']['default'][] = '{'; //bracket after @-rule
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //string before selector
$GLOBALS['csstidy']['predefined_templates']['default'][] = '{'; //bracket after selector
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //string before property
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //string after property+before value
$GLOBALS['csstidy']['predefined_templates']['default'][] = ';'; //string after value
$GLOBALS['csstidy']['predefined_templates']['default'][] = '}'; //closing bracket - selector
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //space between blocks {...}
$GLOBALS['csstidy']['predefined_templates']['default'][] = '}'; //closing bracket @-rule
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; //indent in @-rule
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; // before comment
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; // after comment
$GLOBALS['csstidy']['predefined_templates']['default'][] = ''; // after last line @-rule
