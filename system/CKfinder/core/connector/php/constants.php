...
define('CKFINDER_CONNECTOR_LANG_PATH',ROOTDIR."/lang");
define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH', ROOTDIR."system/CKfinder/config.php");
...
if (CKFINDER_CONNECTOR_PHP_MODE == 4) {
    define('CKFINDER_CONNECTOR_LIB_DIR', ROOTDIR."system/CKfinder/core/connector/php/php4");
} else {
    define('CKFINDER_CONNECTOR_LIB_DIR', ROOTDIR."system/CKfinder/core/connector/php/php5");
}
